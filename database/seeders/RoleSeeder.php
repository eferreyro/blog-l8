...
class RoleSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        Permission::create(['name' => 'admin.categories.destroy'])->syncRoles([$role1]);; //Eliminar Categorias
        ...
        Permission::create(['name' => 'admin.tags.destroy'])->syncRoles([$role1]);; //Eliminar Etiquetas
